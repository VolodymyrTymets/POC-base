...
This repo currently contains one deployable, `api/` (NestJS + GraphQL). A `web/` app is planned
(see root README) and will need its own stack section appended here when it lands.
...
**Stack:** backend **NestJS** · API **GraphQL** (code-first, `schema.gql` generated) · web **none yet** · mobile **none** · ORM **Prisma**
